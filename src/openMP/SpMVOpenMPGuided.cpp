...
#include "SpMVOpenMPGuided.h"

#include <iostream>
#include <omp.h>
#include <stdexcept>

SpMVOpenMPGuided::SpMVOpenMPGuided(const string &n):SpVMInterface(n) {

}

SpMVOpenMPGuided::SpMVOpenMPGuided(const string &n, const utils::CSRMatrix &m, const vector<double> &v): SpVMInterface(n, m, v)  {

}

SpMVOpenMPGuided::~SpMVOpenMPGuided() {
}

vector<double> SpMVOpenMPGuided::computeMultiplication(int numThreads) const {
...
void SpMVOpenMPGuided::runMultiplications() {
    throw logic_error("The model is running OpenMP, not serial");
}

vector<double> SpMVOpenMPGuided::computeMultiplication() const {
    throw logic_error("The model is running OpenMP, not serial");
}


void SpMVOpenMPGuided::runMultiplications(int numThreads) {
    result = computeMultiplication(numThreads);
}

void SpMVOpenMPGuided::runPreprocessing(void* arg) {
}
